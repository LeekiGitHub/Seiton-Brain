...
async def test_process_voice_rejects_oversized_file(mock_download, mock_transcribe, mock_send):
...
async def test_process_voice_accepts_small_file(mock_download, mock_transcribe, mock_process):
    await _process_voice("file123", 42)
