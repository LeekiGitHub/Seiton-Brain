...
3. **Größere Änderungen:** kurz als Issue anlegen oder im PR referenzieren; vor Architektur-Änderungen [`ARCHITECTURE.md`](ARCHITECTURE.md) + relevante [`docs/adr/`](docs/adr/) lesen
4. **Sicherheitslücken:** nicht als öffentliches Issue — siehe [`SECURITY.md`](SECURITY.md)
