# Archiv: Roadmap-Phasen A–H (Epics E1–E26)

> **Ausgelagert im Rahmen von E45-13 (2026-08-29).**  
> Aktive Planung: [`ROADMAP.md`](../../ROADMAP.md) · Kurzstand: [`docs/current-state.md`](../current-state.md)  
> Nichts gelöscht — nur verschoben. Status-Updates für **offene** Rest-Stories
> aus G/H stehen weiterhin in der aktiven ROADMAP; die vollständigen Epic-Tabellen
> (inkl. bereits erledigter Stories) bleiben hier die Referenz.

Status-Legende: 🟢 Done · 🟡 In Progress · 🔵 Ready · ⚪ Backlog · ⚫ Aufgegangen in anderer Story

---

## Epics E1–E26 (Phasen A–H / I-Vorbereitung)
...
| E9-5 | (Eval) Vereinfachter Stack für Consumer-Edition: SQLite statt Postgres, in-process Worker statt Redis/Celery — weniger bewegliche Teile beim Endnutzer. Server-/VPS-Edition behält vollen Stack. Offen: eine vs. zwei Editionen (ADR 0004). → **Ergebnis:** kein Fork, siehe [ADR 0006](../adr/0006-consumer-stack-no-sqlite-fork.md). | 4 | 4 | 4 | 5 | 3 | 🟢 | G |
...
> dass wir etwas dafür maintainen. Siehe [ADR 0004](../adr/0004-commercial-consumer-product.md).
...
**Repo-Strategie:** Public Portfolio jetzt, kommerzielle Edition später — [ADR 0005](../adr/0005-repo-and-license-strategy.md).
...
Details: [`docs/integrations/vault-backends.md`](../integrations/vault-backends.md)
...
Details: [`docs/integrations/knowledge-retrieval.md`](../integrations/knowledge-retrieval.md)
...
ADR 0004, daher zuerst Entscheidung ([ADR 0007](../adr/0007-cloud-edition-subscription.md), Proposed).
...
## Abgeschlossene Sprint-Historie (A, B, H)
